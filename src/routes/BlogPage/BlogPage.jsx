        ...
        <Container>
          ...
          <Row>
            {TrendingSekarang.map((data) =>{
              return  <Col key={data.id} className='shadow rounded-3 mt-4'>
                ...
                <div className="iconbetwen d-flex justify-content-between align-items-center px-2">
                  ...
                  <i class="fa-solid fa-eye"></i><span class="ms-2">769</span>
                </div>
                ...
                <div className='px-2 d-flex justify-content-between align-items-center'>
                  <p>{data.komentar}</p>
                  <button className="btn btn-transparent btn-custom mb-3">{ data.button}<i class="fa-solid fa-arrow-right ms-2"></i></button>
                </div>
              </Col>;
            })}
        ...
        <Container>
          ...
          <Row>
            {UntukmuSekarang.map((data) => {
              return  <Col key={data.id} className=' shadow rounded-3 py-2'>
